...
VIEWPORT_FLAGS_OWNED_BY_APP = enums.ImGuiViewportFlags_OwnedByApp               # Platform Window: is created/managed by the application (rather than a dear meltygui_imgui backend)

include "meltygui_imgui/common.pyx"
...
cdef class _DrawList(object):
    ...
    def add_line(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Line example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_line(20, 35, 180, 80, meltygui_imgui.get_color_u32_rgba(1,1,0,1), 3)
            draw_list.add_line(180, 35, 20, 80, meltygui_imgui.get_color_u32_rgba(1,0,0,1), 3)
            meltygui_imgui.end()
    ...
    def add_rect(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Rect example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_rect(20, 35, 90, 80, meltygui_imgui.get_color_u32_rgba(1,1,0,1), thickness=3)
            draw_list.add_rect(110, 35, 180, 80, meltygui_imgui.get_color_u32_rgba(1,0,0,1), rounding=5, thickness=3)
            meltygui_imgui.end()
    ...
    def add_rect_filled(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Filled rect example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_rect_filled(20, 35, 90, 80, meltygui_imgui.get_color_u32_rgba(1,1,0,1))
            draw_list.add_rect_filled(110, 35, 180, 80, meltygui_imgui.get_color_u32_rgba(1,0,0,1), 5)
            meltygui_imgui.end()
    ...
    def add_rect_filled_multicolor(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Multicolored filled rect example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_rect_filled_multicolor(20, 35, 190, 80, meltygui_imgui.get_color_u32_rgba(1,0,0,1),
                meltygui_imgui.get_color_u32_rgba(0,1,0,1), meltygui_imgui.get_color_u32_rgba(0,0,1,1),
                meltygui_imgui.get_color_u32_rgba(1,1,1,1))
            meltygui_imgui.end()
    ...
    def add_quad(
        ...
        """Add a quad to the list.
            ...
            .. visual-example::
                ...
                meltygui_imgui.begin("Quad example")
                draw_list = meltygui_imgui.get_window_draw_list()
                draw_list.add_quad(20, 35, 85, 30, 90, 80, 17, 76, meltygui_imgui.get_color_u32_rgba(1,1,0,1))
                draw_list.add_quad(110, 35, 177, 33, 180, 80, 112, 79, meltygui_imgui.get_color_u32_rgba(1,0,0,1), 5)
                meltygui_imgui.end()
    ...
    def add_quad_filled(
        ...
        """Add a filled quad to the list.
            ...
            .. visual-example::
                ...
                meltygui_imgui.begin("Filled Quad example")
                draw_list = meltygui_imgui.get_window_draw_list()
                draw_list.add_quad_filled(20, 35, 85, 30, 90, 80, 17, 76, meltygui_imgui.get_color_u32_rgba(1,1,0,1))
                draw_list.add_quad_filled(110, 35, 177, 33, 180, 80, 112, 79, meltygui_imgui.get_color_u32_rgba(1,0,0,1))
                meltygui_imgui.end()
    ...
    def add_triangle(
        ...
        """Add a triangle to the list.
            ...
            .. visual-example::
                ...
                meltygui_imgui.begin("Triangle example")
                draw_list = meltygui_imgui.get_window_draw_list()
                draw_list.add_triangle(20, 35, 90, 35, 55, 80, meltygui_imgui.get_color_u32_rgba(1,1,0,1))
                draw_list.add_triangle(110, 35, 180, 35, 145, 80, meltygui_imgui.get_color_u32_rgba(1,0,0,1), 5)
                meltygui_imgui.end()
    ...
    def add_triangle_filled(
        ...
        """Add a filled triangle to the list.
            ...
            .. visual-example::
                ...
                meltygui_imgui.begin("Filled triangle example")
                draw_list = meltygui_imgui.get_window_draw_list()
                draw_list.add_triangle_filled(20, 35, 90, 35, 55, 80, meltygui_imgui.get_color_u32_rgba(1,1,0,1))
                draw_list.add_triangle_filled(110, 35, 180, 35, 145, 80, meltygui_imgui.get_color_u32_rgba(1,0,0,1))
                meltygui_imgui.end()
    ...
    def add_bezier_cubic(
        ...
        """Add a cubic bezier curve to the list.
            ...
            .. visual-example::
                ...
                meltygui_imgui.begin("Cubic bezier example")
                draw_list = meltygui_imgui.get_window_draw_list()
                draw_list.add_bezier_cubic(20, 35, 90, 80, 110, 180, 145, 35, meltygui_imgui.get_color_u32_rgba(1,1,0,1), 2)
                meltygui_imgui.end()
    ...
    def add_bezier_quadratic(
        ...
        """Add a quadratic bezier curve to the list.
            ...
            .. visual-example::
                ...
                meltygui_imgui.begin("Quadratic bezier example")
                draw_list = meltygui_imgui.get_window_draw_list()
                draw_list.add_bezier_quadratic(20, 35, 90, 80, 145, 35, meltygui_imgui.get_color_u32_rgba(1,1,0,1), 2)
                meltygui_imgui.end()
    ...
    def add_circle(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Circle example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_circle(100, 60, 30, meltygui_imgui.get_color_u32_rgba(1,1,0,1), thickness=3)
            meltygui_imgui.end()
    ...
    def add_circle_filled(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Filled circle example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_circle_filled(100, 60, 30, meltygui_imgui.get_color_u32_rgba(1,1,0,1))
            meltygui_imgui.end()
    ...
    def add_ngon(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Ngon Example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_ngon(100, 60, 30, meltygui_imgui.get_color_u32_rgba(1,1,0,1), 5)
            meltygui_imgui.end()
    ...
    def add_ngon_filled(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Filled Ngon Example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_ngon_filled(100, 60, 30, meltygui_imgui.get_color_u32_rgba(1,1,0,1), 5)
            meltygui_imgui.end()
    ...
    def add_text(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Text example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_text(20, 35, meltygui_imgui.get_color_u32_rgba(1,1,0,1), "Hello!")
            meltygui_imgui.end()
    ...
    def add_image(self,
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Image example")
            texture_id = meltygui_imgui.get_io().fonts.texture_id
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_image(texture_id, (20, 35), (180, 80), col=meltygui_imgui.get_color_u32_rgba(0.5,0.5,1,1))
            meltygui_imgui.end()
    ...
    def add_image_rounded(self,
        ...
        .. visual-example::
            ...
            texture_id = meltygui_imgui.get_io().fonts.texture_id
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_image_rounded(texture_id, (20, 35), (180, 80), col=meltygui_imgui.get_color_u32_rgba(0.5,0.5,1,1), rounding=10)
            meltygui_imgui.end()
    ...
    def add_polyline(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Polyline example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.add_polyline([(20, 35), (90, 35), (55, 80)], meltygui_imgui.get_color_u32_rgba(1,1,0,1), flags=meltygui_imgui.DRAW_NONE, thickness=3)
            draw_list.add_polyline([(110, 35), (180, 35), (145, 80)], meltygui_imgui.get_color_u32_rgba(1,0,0,1), flags=meltygui_imgui.DRAW_CLOSED, thickness=3)
            meltygui_imgui.end()
    ...
    def path_line_to(self, float x, float y):
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Path line to example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.path_clear()
            draw_list.path_line_to(20, 35)
            draw_list.path_line_to(180, 80)
            draw_list.path_stroke(meltygui_imgui.get_color_u32_rgba(1,1,0,1), flags=0, thickness=3)
            draw_list.path_clear()
            draw_list.path_line_to(180, 35)
            draw_list.path_line_to(20, 80)
            draw_list.path_stroke(meltygui_imgui.get_color_u32_rgba(1,0,0,1), flags=0, thickness=3)
            meltygui_imgui.end()
    ...
    def path_arc_to(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Path arc to example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.path_clear()
            ...
            draw_list.path_fill_convex(meltygui_imgui.get_color_u32_rgba(1,0,0,1))
            meltygui_imgui.end()
    ...
    def path_arc_to_fast(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Path arc to fast example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.path_clear()
    ...
    def path_fill_convex(self, cimgui.ImU32 col):
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Path fill convex example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.path_clear()
            draw_list.path_line_to(100, 60)
            draw_list.path_arc_to(100, 60, 30, 0.5, 5.5)
            draw_list.path_fill_convex(meltygui_imgui.get_color_u32_rgba(1,1,0,1))
            meltygui_imgui.end()
    ...
    def path_stroke(
        ...
        .. visual-example::
            ...
            meltygui_imgui.begin("Path stroke example")
            draw_list = meltygui_imgui.get_window_draw_list()
            draw_list.path_clear()
            draw_list.path_line_to(100, 60)
            draw_list.path_arc_to(100, 60, 30, 0.5, 5.5)
            draw_list.path_stroke(meltygui_imgui.get_color_u32_rgba(1,1,0,1), flags=meltygui_imgui.DRAW_CLOSED, thickness=3)
            meltygui_imgui.end()
...
cdef class GuiStyle(object):
    ...
    cdef inline _check_ptr(self):
        if self._ptr is NULL:
            raise RuntimeError(
                "Improperly initialized, use meltygui_imgui.get_style() or "
    ...
    def colors(self):
        ...
        .. visual-example::
            ...
            style = meltygui_imgui.get_style()
            meltygui_imgui.begin("Color window")
            meltygui_imgui.columns(4)
            for color in range(0, meltygui_imgui.COLOR_COUNT):
                meltygui_imgui.text("Color: {}".format(color))
                meltygui_imgui.color_button("color#{}".format(color), *style.colors[color])
                meltygui_imgui.next_column()
...
def end_frame():
    ...
    If you don't need to render, better to not create any meltygui_imgui windows
    instead!
...
def show_user_guide():
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: user guide")
        meltygui_imgui.show_user_guide()
        meltygui_imgui.end()
...
def show_style_editor(GuiStyle style=None):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: my style editor")
        meltygui_imgui.show_style_editor()
        meltygui_imgui.end()
...
def show_demo_window(closable=False):
    ...
    .. visual-example::
        ...
        meltygui_imgui.show_demo_window()
...
def show_test_window():
    ...
    .. visual-example::
        ...
        meltygui_imgui.show_test_window()
...
def show_metrics_window(closable=False):
    ...
    .. visual-example::
        ...
        meltygui_imgui.show_metrics_window()
...
def get_content_region_available():
    ...
    .. code-block: python
        meltygui_imgui.get_content_region_max() - meltygui_imgui.get_cursor_position()
...
def set_window_focus():
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Window 1")
        meltygui_imgui.end()

        meltygui_imgui.begin("Window 2")
        meltygui_imgui.set_window_focus()
        meltygui_imgui.end()
...
def set_window_focus_labeled(str label):
    ...
    .. visual-example::
        ...
        meltygui_imgui.set_window_focus_labeled("Window 2")

        meltygui_imgui.begin("Window 1", True)
        meltygui_imgui.text("Apples")
        meltygui_imgui.end()

        meltygui_imgui.begin("Window 2", True)
        meltygui_imgui.text("Orange")
        meltygui_imgui.end()

        meltygui_imgui.begin("Window 3", True)
        meltygui_imgui.text("Mango")
        meltygui_imgui.end()
    ...
    **Note:** usage of this function is not recommended. prefer using
    ...
    Args:
        ...
        condition (:ref:`condition flag <condition-options>`): defines on which
            condition value should be set. Defaults to :any:`meltygui_imgui.ONCE`.

    .. visual-example::
        :title: window sizing
        :height: 200

        meltygui_imgui.begin("Window size")
        meltygui_imgui.set_window_size(80, 180)
        meltygui_imgui.end()
...
def set_window_size_named(str label, float width, float height, cimgui.ImGuiCond condition = ONCE):
    ...
    .. visual-example::
        ...
        meltygui_imgui.set_window_size_named("Window 1",100,100)
        meltygui_imgui.set_window_size_named("Window 2",100,200)
...
def set_window_font_scale(float scale):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: font scale")
        meltygui_imgui.set_window_font_scale(2.0)
        meltygui_imgui.text("Bigger font")
        meltygui_imgui.end()
...
def set_next_window_collapsed(
    ...
    .. visual-example::
        ...
        meltygui_imgui.set_next_window_collapsed(True)
        meltygui_imgui.begin("Example: collapsed window")
        meltygui_imgui.end()
...
def get_window_draw_list():
    ...
    .. visual-example::
        ...
        for i in range(0, meltygui_imgui.COLOR_COUNT):
            name = meltygui_imgui.get_style_color_name(i);
            draw_list.add_rect_filled(pos_x, pos_y, pos_x+sz, pos_y+sz, meltygui_imgui.get_color_u32_idx(i));
            meltygui_imgui.dummy(sz, sz);
            meltygui_imgui.same_line();

        rgba_color = meltygui_imgui.get_color_u32_rgba(1, 1, 0, 1);
...
def set_next_window_position(
    ...
    Args:
        ...
        condition (:ref:`condition flag <condition-options>`): defines on which
            condition value should be set. Defaults to :any:`meltygui_imgui.ALWAYS`.
    ...
    .. visual-example::
        ...
        meltygui_imgui.set_next_window_size(20, 20)

        for index in range(5):
            meltygui_imgui.set_next_window_position(index * 40, 5)
            meltygui_imgui.begin(str(index))
            meltygui_imgui.end()
...
def set_next_window_size(
    ...
    .. visual-example::
        ...
        meltygui_imgui.set_next_window_position(io.display_size.x * 0.5, io.display_size.y * 0.5, 1, pivot_x = 0.5, pivot_y = 0.5)

        meltygui_imgui.set_next_window_size(80, 180)
        meltygui_imgui.begin("High")
        meltygui_imgui.end()
...
def set_next_window_size_constraints(
    ...
    Args:
        ...
        callback (callable): a callable.
            Callable takes an meltygui_imgui._ImGuiSizeCallbackData object as argument
    ...
    .. visual-example::
        ...
        meltygui_imgui.set_next_window_size_constraints((175,50), (200, 100))
        meltygui_imgui.begin("Constrained Window")
        meltygui_imgui.text("...")
        meltygui_imgui.end()
...
def set_next_window_content_size(float width, float height):
    ...
    .. visual-example::
        ...
        meltygui_imgui.set_window_size(20,20)
        meltygui_imgui.set_next_window_content_size(100,100)

        meltygui_imgui.begin("Window", True)
        meltygui_imgui.text("Some example text")
        meltygui_imgui.end()
...
def set_window_position(float x, float y, cimgui.ImGuiCond condition = ALWAYS):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Window 1")
        meltygui_imgui.set_window_position(20,20)
        meltygui_imgui.end()

        meltygui_imgui.begin("Window 2")
        meltygui_imgui.set_window_position(20,50)
        meltygui_imgui.end()
...
def set_window_position_labeled(str label, float x, float y, cimgui.ImGuiCond condition = ALWAYS):
    ...
    .. visual-example::
        ...
        meltygui_imgui.set_window_position_labeled("Window 1", 20, 50)
        meltygui_imgui.set_window_position_labeled("Window 2", 20, 100)
...
def set_window_collapsed(bool collapsed, cimgui.ImGuiCond condition = ALWAYS):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Window 1")
        meltygui_imgui.set_window_collapsed(True)
        meltygui_imgui.end()
...
def set_window_collapsed_labeled(str label, bool collapsed, cimgui.ImGuiCond condition = ALWAYS):
    ...
    .. visual-example::
        ...
        meltygui_imgui.set_window_collapsed_labeled("Window 1", True)
        meltygui_imgui.begin("Window 1")
        meltygui_imgui.end()
...
def tree_node(str text, cimgui.ImGuiTreeNodeFlags flags=0):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: tree node")
        if meltygui_imgui.tree_node("Expand me!", meltygui_imgui.TREE_NODE_DEFAULT_OPEN):
            meltygui_imgui.text("Lorem Ipsum")
            meltygui_imgui.tree_pop()
        meltygui_imgui.end()
...
def get_tree_node_to_label_spacing():
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("TreeNode")
        meltygui_imgui.text("<- 0px offset here")
        if meltygui_imgui.tree_node("Expand me!", meltygui_imgui.TREE_NODE_DEFAULT_OPEN):
            meltygui_imgui.text("<- %.2fpx offset here" % meltygui_imgui.get_tree_node_to_label_spacing())
            meltygui_imgui.tree_pop()
        meltygui_imgui.end()
...
def collapsing_header(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: collapsing header")
        expanded, visible = meltygui_imgui.collapsing_header("Expand me!", visible)

        if expanded:
            meltygui_imgui.text("Now you see me!")
        meltygui_imgui.end()
...
def set_next_item_open(bool is_open, cimgui.ImGuiCond condition = 0):
    ...
    Args:
        is_open (bool):
        condition (:ref:`condition flag <condition-options>`): defines on which
            condition value should be set. Defaults to :any:`meltygui_imgui.NONE`.
...
def selectable(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: selectable")
        _, selected[0] = meltygui_imgui.selectable(
            "1. I am selectable", selected[0]
        )
        _, selected[1] = meltygui_imgui.selectable(
            "2. I am selectable too", selected[1]
        )
        meltygui_imgui.text("3. I am not selectable")
        meltygui_imgui.end()
...
def listbox(
    ...
    .. visual-example::
        ...
        current = 2
        meltygui_imgui.begin("Example: listbox widget")

        clicked, current = meltygui_imgui.listbox(
...
def begin_list_box(
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Example: custom listbox"):
            with meltygui_imgui.begin_list_box("List", 200, 100) as list_box:
                if list_box.opened:
    ...
    Example::
        ...
        if meltygui_imgui.begin_list_box("List", 200, 100).opened:
...
def listbox_header( # OBSOLETED in 1.81 (from February 2021)
    ...
    """*Obsoleted in meltygui_imgui v1.81 from February 2021, refer to :func:`begin_list_box()`*
...
def listbox_footer(): # OBSOLETED in 1.81 (from February 2021)
    """*Obsoleted in meltygui_imgui v1.81 from February 2021, refer to :func:`end_list_box()`*
...
def set_tooltip(str text):
    ...
    .. visual-example::
        ...
        meltygui_imgui.button("Hover me!")
        if meltygui_imgui.is_item_hovered():
            meltygui_imgui.set_tooltip("Please?")
        meltygui_imgui.end()
        ...
        with meltygui_imgui.begin("Example: tooltip"):
            ...
            if meltygui_imgui.is_item_hovered():
                with meltygui_imgui.begin_tooltip():
                    ...
                    meltygui_imgui.text("This button has full window tooltip.")
                    texture_id = meltygui_imgui.get_io().fonts.texture_id
                    meltygui_imgui.image(texture_id, 512, 64, border_color=(1, 0, 0, 1))
...
def begin_main_menu_bar():
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin_main_menu_bar() as main_menu_bar:
            if main_menu_bar.opened:
                # first menu dropdown
                with meltygui_imgui.begin_menu('File', True) as file_menu:
                    if file_menu.opened:
                        meltygui_imgui.menu_item('New', 'Ctrl+N', False, True)
                        meltygui_imgui.menu_item('Open ...', 'Ctrl+O', False, True)

                        # submenu
                        with meltygui_imgui.begin_menu('Open Recent', True) as open_recent_menu:
                            if open_recent_menu.opened:
                                meltygui_imgui.menu_item('doc.txt', None, False, True)

    Example::

        if meltygui_imgui.begin_main_menu_bar().opened:
            # first menu dropdown
            if meltygui_imgui.begin_menu('File', True).opened:
                meltygui_imgui.menu_item('New', 'Ctrl+N', False, True)
                meltygui_imgui.menu_item('Open ...', 'Ctrl+O', False, True)

                # submenu
                if meltygui_imgui.begin_menu('Open Recent', True).opened:
                    meltygui_imgui.menu_item('doc.txt', None, False, True)
...
def begin_menu_bar():
    ...
    **Note:** this requires :ref:`WINDOW_MENU_BAR <window-flag-options>` flag
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Child Window - File Browser", flags=flags):
            with meltygui_imgui.begin_menu_bar() as menu_bar:
                if menu_bar.opened:
                    with meltygui_imgui.begin_menu('File') as file_menu:
                        if file_menu.opened:
    ...
    Example::
        ...
        if meltygui_imgui.begin_menu_bar().opened:
            if meltygui_imgui.begin_menu('File').opened:
                meltygui_imgui.menu_item('Close')
                meltygui_imgui.end_menu()
...
def open_popup(str label, cimgui.ImGuiPopupFlags flags=0):
    ...
    .. visual-example::
        ...
        if meltygui_imgui.button('Toggle..'):
            meltygui_imgui.open_popup("toggle")
        if meltygui_imgui.begin_popup("toggle"):
            if meltygui_imgui.begin_menu('Sub-menu'):
                _, _ = meltygui_imgui.menu_item('Click me')
                meltygui_imgui.end_menu()
...
def begin_popup(str label, cimgui.ImGuiWindowFlags flags=0):
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Example: simple popup"):
            if meltygui_imgui.button("select"):
                meltygui_imgui.open_popup("select-popup")

            meltygui_imgui.same_line()

            with meltygui_imgui.begin_popup("select-popup") as select_popup:
                if select_popup.opened:
                    meltygui_imgui.text("Select one")
                    meltygui_imgui.separator()
                    meltygui_imgui.selectable("One")
                    meltygui_imgui.selectable("Two")
                    meltygui_imgui.selectable("Three")
...
def begin_popup_modal(str title, visible=None, cimgui.ImGuiWindowFlags flags=0):
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Example: simple popup modal"):
            if meltygui_imgui.button("Open Modal popup"):
                meltygui_imgui.open_popup("select-popup")

            meltygui_imgui.same_line()

            with meltygui_imgui.begin_popup_modal("select-popup") as select_popup:
                if select_popup.opened:
                    meltygui_imgui.text("Select an option:")
                    meltygui_imgui.separator()
                    meltygui_imgui.selectable("One")
                    meltygui_imgui.selectable("Two")
                    meltygui_imgui.selectable("Three")
    ...
    Example::
        ...
        if meltygui_imgui.begin_popup_modal("select-popup").opened:
            meltygui_imgui.text("Select an option:")
            meltygui_imgui.separator()
            meltygui_imgui.selectable("One")
            meltygui_imgui.selectable("Two")
...
def begin_popup_context_item(str label = None, cimgui.ImGuiPopupFlags mouse_button = 1):
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Example: popup context view"):
            meltygui_imgui.text("Right-click to set value.")
            with meltygui_imgui.begin_popup_context_item("Item Context Menu", mouse_button=0) as popup:
                if popup.opened:
                    meltygui_imgui.selectable("Set to Zero")

    Example::

        meltygui_imgui.begin("Example: popup context view")
        meltygui_imgui.text("Right-click to set value.")
        if meltygui_imgui.begin_popup_context_item("Item Context Menu", mouse_button=0):
            meltygui_imgui.selectable("Set to Zero")
            meltygui_imgui.end_popup()
        meltygui_imgui.end()
...
def begin_popup_context_window(
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Example: popup context window"):
            with meltygui_imgui.begin_popup_context_window(popup_flags=meltygui_imgui.POPUP_NONE) as context_window:
                if context_window.opened:
                    meltygui_imgui.selectable("Clear")

    Example::

        meltygui_imgui.begin("Example: popup context window")
        if meltygui_imgui.begin_popup_context_window(popup_flags=meltygui_imgui.POPUP_NONE):
            meltygui_imgui.selectable("Clear")
            meltygui_imgui.end_popup()
        meltygui_imgui.end()
...
def text(str text):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: simple text")
        meltygui_imgui.text("Simple text")
        meltygui_imgui.end()
...
def text_colored(str text, float r, float g, float b, float a=1.):
    ...
    .. code-block:: python
        ...
        meltygui_imgui.push_style_color(meltygui_imgui.COLOR_TEXT, r, g, b, a)
        meltygui_imgui.text(text)
        meltygui_imgui.pop_style_color()
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: colored text")
        meltygui_imgui.text_colored("Colored text", 1, 0, 0)
        meltygui_imgui.end()
...
def text_disabled(str text):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: disabled text")
        meltygui_imgui.text_disabled("Disabled text")
        meltygui_imgui.end()
...
def text_wrapped(str text):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Text wrap")
        # Resize the window to see text wrapping
        meltygui_imgui.text_wrapped("This text will wrap around.")
        meltygui_imgui.end()
...
def label_text(str label, str text):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: text with label")
        meltygui_imgui.label_text("my label", "my text")
        meltygui_imgui.end()
...
def text_unformatted(str text):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: unformatted text")
        meltygui_imgui.text_unformatted("Really ... long ... text")
        meltygui_imgui.end()
...
def bullet():
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: bullets")

        for i in range(10):
            meltygui_imgui.bullet()
...
def bullet_text(str text):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: bullet text")
        meltygui_imgui.bullet_text("Bullet 1")
        meltygui_imgui.bullet_text("Bullet 2")
        meltygui_imgui.bullet_text("Bullet 3")
        meltygui_imgui.end()
...
def button(str label, width=0, height=0):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: button")
        meltygui_imgui.button("Button 1")
        meltygui_imgui.button("Button 2")
        meltygui_imgui.end()
...
def small_button(str label):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: button")
        meltygui_imgui.small_button("Button 1")
        meltygui_imgui.small_button("Button 2")
        meltygui_imgui.end()
...
def arrow_button(str label, cimgui.ImGuiDir direction = DIRECTION_NONE):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Arrow button")
        meltygui_imgui.arrow_button("Button", meltygui_imgui.DIRECTION_LEFT)
        meltygui_imgui.end()

    Args:
        label (str): button label.
        direction = meltygui_imgui direction constant
...
def invisible_button(str identifier, float width, float height, cimgui.ImGuiButtonFlags flags = 0):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: invisible button :)")
        meltygui_imgui.invisible_button("Button 1", 200, 200)
        meltygui_imgui.small_button("Button 2")
        meltygui_imgui.end()
...
def color_button(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: color button")
        meltygui_imgui.color_button("Button 1", 1, 0, 0, 1, 0, 10, 10)
        meltygui_imgui.color_button("Button 2", 0, 1, 0, 1, 0, 10, 10)
        meltygui_imgui.color_button("Wide Button", 0, 0, 1, 1, 0, 20, 10)
        meltygui_imgui.color_button("Tall Button", 1, 0, 1, 1, 0, 10, 20)
        meltygui_imgui.end()
...
def image(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: image display")
        meltygui_imgui.image(texture_id, 512, 64, border_color=(1, 0, 0, 1))
        meltygui_imgui.end()
...
def checkbox(str label, cimgui.bool state):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: checkboxes")
        ...
        #       checkbox state.
        _, checkbox1_enabled = meltygui_imgui.checkbox("Checkbox 1", checkbox1_enabled)
        _, checkbox2_enabled = meltygui_imgui.checkbox("Checkbox 2", checkbox2_enabled)

        meltygui_imgui.text("Checkbox 1 state value: {}".format(checkbox1_enabled))
        meltygui_imgui.text("Checkbox 2 state value: {}".format(checkbox2_enabled))
...
def checkbox_flags(str label, unsigned int flags, unsigned int flags_value):
    ...
    .. visual-example::
        ...
        flags = meltygui_imgui.WINDOW_NO_RESIZE | meltygui_imgui.WINDOW_NO_MOVE

        meltygui_imgui.begin("Example: checkboxes for flags", flags=flags)

        clicked, flags = meltygui_imgui.checkbox_flags(
            "No resize", flags, meltygui_imgui.WINDOW_NO_RESIZE
        )
        clicked, flags = meltygui_imgui.checkbox_flags(
            "No move", flags, meltygui_imgui.WINDOW_NO_MOVE
        )
        clicked, flags = meltygui_imgui.checkbox_flags(
            "No collapse", flags, meltygui_imgui.WINDOW_NO_COLLAPSE
        )
        # note: it also allows to use multiple flags at once
        clicked, flags = meltygui_imgui.checkbox_flags(
            "No resize & no move", flags,
            meltygui_imgui.WINDOW_NO_RESIZE | meltygui_imgui.WINDOW_NO_MOVE
        )
        meltygui_imgui.text("Current flags value: {0:b}".format(flags))
        meltygui_imgui.end()
...
def radio_button(str label, cimgui.bool active):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: radio buttons")

        if meltygui_imgui.radio_button("Radio button", radio_active):
...
def begin_combo(str label, str preview_value, cimgui.ImGuiComboFlags flags = 0):
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Example: begin combo"):
            with meltygui_imgui.begin_combo("combo", items[selected]) as combo:
                if combo.opened:
                    for i, item in enumerate(items):
                        is_selected = (i == selected)
                        if meltygui_imgui.selectable(item, is_selected)[0]:
                            selected = i

                        # Set the initial focus when opening the combo (scrolling + keyboard navigation focus)
                        if is_selected:
                            meltygui_imgui.set_item_default_focus()
    ...
    Example::
        ...
        meltygui_imgui.begin("Example: begin combo")
        if meltygui_imgui.begin_combo("combo", items[selected]):
            for i, item in enumerate(items):
                is_selected = (i == selected)
                if meltygui_imgui.selectable(item, is_selected)[0]:
                    selected = i
...
def combo(str label, int current, list items, int height_in_items=-1):
    ...
    .. visual-example::
        ...
        current = 2
        meltygui_imgui.begin("Example: combo widget")

        clicked, current = meltygui_imgui.combo(
...
def color_edit3(str label, float r, float g, float b, cimgui.ImGuiColorEditFlags flags = 0):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: color edit without alpha")
        ...
        #       of color
        changed, color_1 = meltygui_imgui.color_edit3("Color 1", *color_1)
        changed, color_2 = meltygui_imgui.color_edit3("Color 2", *color_2)
...
def color_edit4(str label, float r, float g, float b, float a, cimgui.ImGuiColorEditFlags flags = 0):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: color edit with alpha")

        # note: first element of return two-tuple notifies if the color was changed
        #       in currently processed frame and second element is current value
        #       of color and alpha
        _, color = meltygui_imgui.color_edit4("Alpha", *color)
        _, color = meltygui_imgui.color_edit4("No alpha", *color, meltygui_imgui.COLOR_EDIT_NO_ALPHA)
...
def drag_float(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag float")
        changed, value = meltygui_imgui.drag_float(
            "Default", value,
        )
        changed, value = meltygui_imgui.drag_float(
            "Less precise", value, format="%.1f"
        )
        meltygui_imgui.text("Changed: %s, Value: %s" % (changed, value))
        meltygui_imgui.end()
    ...
    """
    assert (power == 1), "power parameter obsoleted in ImGui 1.78, use meltygui_imgui.SLIDER_FLAGS_LOGARITHMIC instead"
...
def drag_float2(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag float")
        changed, values = meltygui_imgui.drag_float2(
            "Default", *values
        )
        changed, values = meltygui_imgui.drag_float2(
            "Less precise", *values, format="%.1f"
        )
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def drag_float3(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag float")
        changed, values = meltygui_imgui.drag_float3(
            "Default", *values
        )
        changed, values = meltygui_imgui.drag_float3(
            "Less precise", *values, format="%.1f"
...
def drag_float4(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag float")
        changed, values = meltygui_imgui.drag_float4(
            "Default", *values
        )
        changed, values = meltygui_imgui.drag_float4(
            "Less precise", *values, format="%.1f"
...
def drag_float_range2(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag float range")
        changed, vmin, vmax = meltygui_imgui.drag_float_range2( "Drag Range", vmin, vmax )
        meltygui_imgui.text("Changed: %s, Range: (%.2f, %.2f)" % (changed, vmin, vmax))
        meltygui_imgui.end()
...
def drag_int(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag int")
        changed, value = meltygui_imgui.drag_int("drag int", value,)
        meltygui_imgui.text("Changed: %s, Value: %s" % (changed, value))
        meltygui_imgui.end()
...
def drag_int2(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag int")
        changed, values = meltygui_imgui.drag_int2(
            "drag ints", *values
        )
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def drag_int3(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag int")
        changed, values = meltygui_imgui.drag_int3(
            "drag ints", *values
        )
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def drag_int4(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag int")
        changed, values = meltygui_imgui.drag_int4(
            "drag ints", *values
        )
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def drag_int_range2(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: drag float range")
        changed, vmin, vmax = meltygui_imgui.drag_int_range2( "Drag Range", vmin, vmax )
        meltygui_imgui.text("Changed: %s, Range: (%d, %d)" % (changed, vmin, vmax))
        meltygui_imgui.end()
...
def input_text(
    ...
    If set to -1, the internal buffer will have an adaptive size, which is equivalent to using the ``meltygui_imgui.INPUT_TEXT_CALLBACK_RESIZE`` flag.
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: text input")
        changed, text_val = meltygui_imgui.input_text('Coefficient:', text_val)
        meltygui_imgui.text('You wrote:')
        meltygui_imgui.same_line()
        meltygui_imgui.text(text_val)
        meltygui_imgui.end()
    ...
    Args:
        ...
        callback (callable): a callable that is called depending on choosen flags.
            Callable takes an meltygui_imgui._ImGuiInputTextCallbackData object as argument
...
def input_text_multiline(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: text input")
        changed, text_val = meltygui_imgui.input_text_multiline(
            'Message:',
            text_val,
            2056
        )
...
def input_text_with_hint(
    ...
    .. visual-example::
        ...
        text_val = ''
        meltygui_imgui.begin("Example Text With hing")
        changed, text_val = meltygui_imgui.input_text_with_hint(
...
def input_float(
    ...
    .. visual-example::
        ...
        float_val = 0.4
        meltygui_imgui.begin("Example: float input")
        changed, float_val = meltygui_imgui.input_float('Type coefficient:', float_val)
        meltygui_imgui.text('You wrote: %f' % float_val)
        meltygui_imgui.end()
...
def input_float2(
    ...
    .. visual-example::
        ...
        values = 0.4, 3.2
        meltygui_imgui.begin("Example: two float inputs")
        changed, values = meltygui_imgui.input_float2('Type here:', *values)
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def input_float3(
    ...
    .. visual-example::
        ...
        values = 0.4, 3.2, 29.3
        meltygui_imgui.begin("Example: three float inputs")
        changed, values = meltygui_imgui.input_float3('Type here:', *values)
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def input_float4(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: four float inputs")
        changed, values = meltygui_imgui.input_float4('Type here:', *values)
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def input_int(
    ...
    .. visual-example::
        ...
        int_val = 3
        meltygui_imgui.begin("Example: integer input")
        changed, int_val = meltygui_imgui.input_int('Type multiplier:', int_val)
        meltygui_imgui.text('You wrote: %i' % int_val)
        meltygui_imgui.end()
...
def input_int2(
    ...
    .. visual-example::
        ...
        values = 4, 12
        meltygui_imgui.begin("Example: two int inputs")
        changed, values = meltygui_imgui.input_int2('Type here:', *values)
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def input_int3(
    ...
    .. visual-example::
        ...
        values = 4, 12, 28
        meltygui_imgui.begin("Example: three int inputs")
        changed, values = meltygui_imgui.input_int3('Type here:', *values)
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def input_int4(
    ...
    .. visual-example::
        ...
        values = 4, 12, 28, 73
        meltygui_imgui.begin("Example: four int inputs")
        changed, values = meltygui_imgui.input_int4('Type here:', *values)
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def input_double(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: double input")
        changed, double_val = meltygui_imgui.input_double('Type multiplier:', double_val)
        meltygui_imgui.text('You wrote: %i' % double_val)
        meltygui_imgui.end()
...
def slider_float(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: slider float")
        changed, value = meltygui_imgui.slider_float(
            "slide floats", value,
...
def slider_float2(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: slider float2")
        changed, values = meltygui_imgui.slider_float2(
            "slide floats", *values,
            min_value=0.0, max_value=100.0,
            format="%.0f"
        )
...
def slider_float3(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: slider float3")
        changed, values = meltygui_imgui.slider_float3(
            "slide floats", *values,
            min_value=0.0, max_value=100.0,
            format="%.0f"
        )
...
def slider_float4(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: slider float4")
        changed, values = meltygui_imgui.slider_float4(
            "slide floats", *values,
            min_value=0.0, max_value=100.0,
            format="%.0f"
        )
...
def slider_angle(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: slider angle")
        changed, radian = meltygui_imgui.slider_angle(
            "slider angle", radian,
            value_degrees_min=0.0, value_degrees_max=180.0)
        meltygui_imgui.text("Changed: %s, Value: %s" % (changed, radian))
        meltygui_imgui.end()
...
def slider_int(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: slider int")
        changed, values = meltygui_imgui.slider_int(
            "slide ints", value,
            min_value=0, max_value=100,
            format="%d"
        )
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, value))
        meltygui_imgui.end()
...
def slider_int2(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: slider int2")
        changed, values = meltygui_imgui.slider_int2(
            "slide ints2", *values,
            min_value=0, max_value=100,
            format="%d"
        )
...
def slider_int3(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: slider int3")
        changed, values = meltygui_imgui.slider_int3(
            "slide ints3", *values,
            min_value=0, max_value=100,
            format="%d"
        )
...
def slider_int4(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: slider int4")
        changed, values = meltygui_imgui.slider_int4(
            "slide ints", *values,
...
def v_slider_float(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: vertical slider float")
        changed, values = meltygui_imgui.v_slider_float(
            "vertical slider float",
            width, height, value,
            min_value=0, max_value=100,
            format="%0.3f", flags=meltygui_imgui.SLIDER_FLAGS_NONE
        )
        meltygui_imgui.text("Changed: %s, Values: %s" % (changed, values))
        meltygui_imgui.end()
...
def v_slider_int(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: vertical slider int")
        changed, values = meltygui_imgui.v_slider_int(
            "vertical slider int",
            width, height, value,
            min_value=0, max_value=100,
            format="%d"
...
def plot_lines(
    ...
    * **stride** (*int*): Number of bytes to move to read next element.
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Plot example")
        meltygui_imgui.plot_lines("Sin(t)", plot_values)
        meltygui_imgui.end()
...
def plot_histogram(
    ...
    * **stride** (*int*): Number of bytes to move to read next element.
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Plot example")
        meltygui_imgui.plot_histogram("histogram(random())", histogram_values)
        meltygui_imgui.end()
...
def progress_bar(float fraction, size = (-FLOAT_MIN,0), str overlay = ""):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Progress bar example")
        meltygui_imgui.progress_bar(0.7, (100,20), "Overlay text")
        meltygui_imgui.end()
...
def get_background_draw_list():
    ...
    Useful to quickly draw shapes/text behind dear meltygui_imgui contents.
...
def get_foreground_draw_list():
    ...
    Useful to quickly draw shapes/text over dear meltygui_imgui contents.
...
def is_key_down(int key_index):
    """Returns if key is being held -- io.KeysDown[user_key_index].
       Note that meltygui_imgui doesn't know the semantic of each entry of
...
def push_font(_Font font):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Default Window")

        meltygui_imgui.text("Text displayed using default font")

        meltygui_imgui.push_font(new_font)
        meltygui_imgui.text("Text displayed using custom font")
        meltygui_imgui.pop_font()
...
cpdef calc_text_size(str text, bool hide_text_after_double_hash = False, float wrap_width = -1.0):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Text size calculation")
        text_content = "This is a ##text##!"
        text_size1 = meltygui_imgui.calc_text_size(text_content)
        meltygui_imgui.text('"%s" has size %ix%i' % (text_content, text_size1[0], text_size1[1]))
        text_size2 = meltygui_imgui.calc_text_size(text_content, True)
        meltygui_imgui.text('"%s" has size %ix%i' % (text_content, text_size2[0], text_size2[1]))
        text_size3 = meltygui_imgui.calc_text_size(text_content, False, 30.0)
        meltygui_imgui.text('"%s" has size %ix%i' % (text_content, text_size3[0], text_size3[1]))
        meltygui_imgui.end()
...
cpdef push_style_var(cimgui.ImGuiStyleVar variable, value):
    ...
    **Note:** variables pushed on stack need to be poped using
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: style variables")
        meltygui_imgui.push_style_var(meltygui_imgui.STYLE_ALPHA, 0.2)
        meltygui_imgui.text("Alpha text")
        meltygui_imgui.pop_style_var(1)
        meltygui_imgui.end()

    Args:
        variable: meltygui_imgui style variable constant
...
cpdef push_style_color(
    ...
    **Note:** variables pushed on stack need to be popped using
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: Color variables")
        meltygui_imgui.push_style_color(meltygui_imgui.COLOR_TEXT, 1.0, 0.0, 0.0)
        meltygui_imgui.text("Colored text")
        meltygui_imgui.pop_style_color(1)
        meltygui_imgui.end()

    Args:
        variable: meltygui_imgui style color constant
        r (float): red color intensity.
        g (float): green color intensity.
        b (float): blue color instensity.
        a (float): alpha intensity.
...
cpdef push_item_width(float item_width):
    ...
    **Note:** width pushed on stack need to be poped using
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: item width")

        # custom width
        meltygui_imgui.push_item_width(meltygui_imgui.get_window_width() * 0.33)
        meltygui_imgui.text('Lorem Ipsum ...')
        meltygui_imgui.slider_float('float slider', 10.2, 0.0, 20.0, '%.2f', 1.0)
        meltygui_imgui.pop_item_width()
...
cpdef set_next_item_width(float item_width):
    ...
    * ``<0.0`` - align xx pixels to the right of window
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Exemple: Next item width")
        meltygui_imgui.set_next_item_width(meltygui_imgui.get_window_width() * 0.33)
        meltygui_imgui.slider_float('Slider 1', 10.2, 0.0, 20.0, '%.2f', 1.0)
        meltygui_imgui.slider_float('Slider 2', 10.2, 0.0, 20.0, '%.2f', 1.0)
        meltygui_imgui.end()
...
def separator():
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: separators")

        meltygui_imgui.text("Some text with bullets")
        meltygui_imgui.bullet_text("Bullet A")
        meltygui_imgui.bullet_text("Bullet A")

        meltygui_imgui.separator()

        meltygui_imgui.text("Another text with bullets")
        meltygui_imgui.bullet_text("Bullet A")
        meltygui_imgui.bullet_text("Bullet A")
...
def same_line(float position=0.0, float spacing=-1.0):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: same line widgets")

        meltygui_imgui.text("same_line() with defaults:")
        meltygui_imgui.button("yes"); meltygui_imgui.same_line()
        meltygui_imgui.button("no")

        meltygui_imgui.text("same_line() with fixed position:")
        meltygui_imgui.button("yes"); meltygui_imgui.same_line(position=50)
        meltygui_imgui.button("no")

        meltygui_imgui.text("same_line() with spacing:")
        meltygui_imgui.button("yes"); meltygui_imgui.same_line(spacing=50)
        meltygui_imgui.button("no")
...
def spacing():
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: vertical spacing")

        meltygui_imgui.text("Some text with bullets:")
        meltygui_imgui.bullet_text("Bullet A")
        meltygui_imgui.bullet_text("Bullet A")

        meltygui_imgui.spacing(); meltygui_imgui.spacing()
...
def dummy(width, height):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: dummy elements")

        meltygui_imgui.text("Some text with bullets:")
        meltygui_imgui.bullet_text("Bullet A")
        meltygui_imgui.bullet_text("Bullet B")

        meltygui_imgui.dummy(0, 50)
        meltygui_imgui.bullet_text("Text after dummy")
...
def indent(float width=0.0):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: item indenting")

        meltygui_imgui.text("Some text with bullets:")

        meltygui_imgui.bullet_text("Bullet A")
        meltygui_imgui.indent()
        meltygui_imgui.bullet_text("Bullet B (first indented)")
        meltygui_imgui.bullet_text("Bullet C (indent continues)")
        meltygui_imgui.unindent()
        meltygui_imgui.bullet_text("Bullet D (indent cleared)")
...
def unindent(float width=0.0):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: item unindenting")

        meltygui_imgui.text("Some text with bullets:")

        meltygui_imgui.bullet_text("Bullet A")
        meltygui_imgui.unindent(10)
        meltygui_imgui.bullet_text("Bullet B (first unindented)")
        meltygui_imgui.bullet_text("Bullet C (unindent continues)")
        meltygui_imgui.indent(10)
        meltygui_imgui.bullet_text("Bullet C (unindent cleared)")
...
def columns(int count=1, str identifier=None, bool border=True):
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: Columns - File list")
        meltygui_imgui.columns(4, 'fileLlist')
        meltygui_imgui.separator()
        meltygui_imgui.text("ID")
        meltygui_imgui.next_column()
        meltygui_imgui.text("File")
        meltygui_imgui.next_column()
        meltygui_imgui.text("Size")
        meltygui_imgui.next_column()
        meltygui_imgui.text("Last Modified")
        meltygui_imgui.next_column()
        meltygui_imgui.separator()
        meltygui_imgui.set_column_offset(1, 40)

        meltygui_imgui.next_column()
        meltygui_imgui.text('FileA.txt')
        meltygui_imgui.next_column()
        meltygui_imgui.text('57 Kb')
        meltygui_imgui.next_column()
        meltygui_imgui.text('12th Feb, 2016 12:19:01')
        meltygui_imgui.next_column()

        meltygui_imgui.next_column()
        meltygui_imgui.text('ImageQ.png')
        meltygui_imgui.next_column()
        meltygui_imgui.text('349 Kb')
        meltygui_imgui.next_column()
        meltygui_imgui.text('1st Mar, 2016 06:38:22')
        meltygui_imgui.next_column()

        meltygui_imgui.columns(1)
        meltygui_imgui.end()
...
def begin_tab_item(str label, opened = None, cimgui.ImGuiTabItemFlags flags = 0):
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Example Tab Bar"):
            with meltygui_imgui.begin_tab_bar("MyTabBar") as tab_bar:
                if tab_bar.opened:
                    with meltygui_imgui.begin_tab_item("Item 1") as item1:
                        if item1.selected:
                            meltygui_imgui.text("Here is the tab content!")

                    with meltygui_imgui.begin_tab_item("Item 2") as item2:
                        if item2.selected:
                            meltygui_imgui.text("Another content...")

                    with meltygui_imgui.begin_tab_item("Item 3", opened=opened_state) as item3:
                        opened_state = item3.opened
                        if item3.selected:
                            meltygui_imgui.text("Hello Saylor!")
    ...
    Example::
        ...
        if meltygui_imgui.begin_tab_bar("MyTabBar"):
            ...
            if meltygui_imgui.begin_tab_item("Item 1").selected:
                meltygui_imgui.text("Here is the tab content!")
                meltygui_imgui.end_tab_item()

            if meltygui_imgui.begin_tab_item("Item 2").selected:
                meltygui_imgui.text("Another content...")
                meltygui_imgui.end_tab_item()

            selected, opened_state = meltygui_imgui.begin_tab_item("Item 3", opened=opened_state)
            if selected:
                meltygui_imgui.text("Hello Saylor!")
                meltygui_imgui.end_tab_item()
...
def tab_item_button(str label, cimgui.ImGuiTabItemFlags flags = 0):
    ...
    .. visual-example:
        ...
        if meltygui_imgui.begin_tab_bar("MyTabBar"):
            ...
            if meltygui_imgui.tab_item_button("Click me!"):
                print('Clicked!')
...
def set_tab_item_closed(str tab_or_docked_window_label):
    ...
    .. visual-example:
        ...
        if meltygui_imgui.begin_tab_bar("MyTabBar"):
            ...
            if meltygui_imgui.begin_tab_item("Item 2")[0]:
                meltygui_imgui.text("This item won't whow !")
                meltygui_imgui.end_tab_item()

            meltygui_imgui.set_tab_item_closed("Item 2")
    ...
    **Note:** this is a beta API.
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Example: drag and drop"):
            ...
            with meltygui_imgui.begin_drag_drop_source() as drag_drop_src:
                if drag_drop_src.dragging:
                    meltygui_imgui.set_drag_drop_payload('itemtype', b'payload')
                    meltygui_imgui.button('dragged source')

            meltygui_imgui.button('dest')
            with meltygui_imgui.begin_drag_drop_target() as drag_drop_dst:
...
def push_clip_rect(
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example Cliprect")
        
        winpos = meltygui_imgui.get_window_position()
        meltygui_imgui.push_clip_rect(0+winpos.x,0+winpos.y,100+winpos.x,100+winpos.y)
        meltygui_imgui.push_clip_rect(50+winpos.x,50+winpos.y,100+winpos.x,100+winpos.y, True)
        
        meltygui_imgui.text('Lorem ipsum dolor sit amet, consectetur adipiscing elit.')
        meltygui_imgui.text('Vivamus mattis velit ac ex auctor gravida.')
        meltygui_imgui.text('Quisque varius erat finibus porta interdum.')
        meltygui_imgui.text('Nam neque magna, dapibus placerat urna eget, facilisis malesuada ipsum.')
        
        meltygui_imgui.pop_clip_rect()
        meltygui_imgui.pop_clip_rect()
    ...
    .. visual-example::
        ...
        with meltygui_imgui.begin("Example: item groups"):
            ...
            with meltygui_imgui.begin_group():
                ...
                meltygui_imgui.button("Button A")
                meltygui_imgui.button("Button B")

            meltygui_imgui.same_line(spacing=50)

            with meltygui_imgui.begin_group():
                meltygui_imgui.text("Second group (text and bullet texts):")
                meltygui_imgui.bullet_text("Bullet A")
                meltygui_imgui.bullet_text("Bullet B")
...
def _ansifeed_text_ansi(str text):
    ...
    Similar to meltygui_imgui.text, but with ANSI parsing.
    meltygui_imgui.text documentation below:
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: simple text")
        meltygui_imgui.extra.text_ansi("Default \033[31m colored \033[m default")
        meltygui_imgui.end()
...
def _ansifeed_text_ansi_colored(str text, float r, float g, float b, float a=1.):
    ...
    Similar to meltygui_imgui.text_colored, but with ANSI parsing.
    meltygui_imgui.text_colored documentation below:
    ...
    .. code-block:: python
        ...
        meltygui_imgui.push_style_color(meltygui_imgui.COLOR_TEXT, r, g, b, a)
        meltygui_imgui.extra.text_ansi(text)
        meltygui_imgui.pop_style_color()
    ...
    .. visual-example::
        ...
        meltygui_imgui.begin("Example: colored text")
        meltygui_imgui.text_ansi_colored("Default \033[31m colored \033[m default", 1, 0, 0)
        meltygui_imgui.end()
...
def _py_font(_Font font):
    ...
    .. visual-example::
        ...
        meltygui_imgui.text("Text displayed using default font")
        with meltygui_imgui.font(new_font):
            meltygui_imgui.text("Text displayed using custom font")
