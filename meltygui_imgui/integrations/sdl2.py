...
class SDL2Renderer(ProgrammablePipelineRenderer):
    ...
    def _map_keys(self):
        ...
        key_map[meltygui_imgui.KEY_TAB] = SDL_SCANCODE_TAB
        key_map[meltygui_imgui.KEY_LEFT_ARROW] = SDL_SCANCODE_LEFT
        key_map[meltygui_imgui.KEY_RIGHT_ARROW] = SDL_SCANCODE_RIGHT
        key_map[meltygui_imgui.KEY_UP_ARROW] = SDL_SCANCODE_UP
        key_map[meltygui_imgui.KEY_DOWN_ARROW] = SDL_SCANCODE_DOWN
        key_map[meltygui_imgui.KEY_PAGE_UP] = SDL_SCANCODE_PAGEUP
        key_map[meltygui_imgui.KEY_PAGE_DOWN] = SDL_SCANCODE_PAGEDOWN
        key_map[meltygui_imgui.KEY_HOME] = SDL_SCANCODE_HOME
        key_map[meltygui_imgui.KEY_END] = SDL_SCANCODE_END
        key_map[meltygui_imgui.KEY_INSERT] = SDL_SCANCODE_INSERT
        key_map[meltygui_imgui.KEY_DELETE] = SDL_SCANCODE_DELETE
        key_map[meltygui_imgui.KEY_BACKSPACE] = SDL_SCANCODE_BACKSPACE
        key_map[meltygui_imgui.KEY_SPACE] = SDL_SCANCODE_SPACE
        key_map[meltygui_imgui.KEY_ENTER] = SDL_SCANCODE_RETURN
        key_map[meltygui_imgui.KEY_ESCAPE] = SDL_SCANCODE_ESCAPE
        key_map[meltygui_imgui.KEY_PAD_ENTER] = SDL_SCANCODE_KP_ENTER
        key_map[meltygui_imgui.KEY_A] = SDL_SCANCODE_A
        key_map[meltygui_imgui.KEY_C] = SDL_SCANCODE_C
        key_map[meltygui_imgui.KEY_V] = SDL_SCANCODE_V
        key_map[meltygui_imgui.KEY_X] = SDL_SCANCODE_X
        key_map[meltygui_imgui.KEY_Y] = SDL_SCANCODE_Y
        key_map[meltygui_imgui.KEY_Z] = SDL_SCANCODE_Z
