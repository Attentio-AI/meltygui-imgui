...
class ProgrammablePipelineRenderer(BaseOpenGLRenderer):
    ...
    def _create_device_objects(self):
        ...
        gl.glVertexAttribPointer(self._attrib_location_position, 2, gl.GL_FLOAT, gl.GL_FALSE, meltygui_imgui.VERTEX_SIZE, ctypes.c_void_p(meltygui_imgui.VERTEX_BUFFER_POS_OFFSET))
        gl.glVertexAttribPointer(self._attrib_location_uv, 2, gl.GL_FLOAT, gl.GL_FALSE, meltygui_imgui.VERTEX_SIZE, ctypes.c_void_p(meltygui_imgui.VERTEX_BUFFER_UV_OFFSET))
        gl.glVertexAttribPointer(self._attrib_location_color, 4, gl.GL_UNSIGNED_BYTE, gl.GL_TRUE, meltygui_imgui.VERTEX_SIZE, ctypes.c_void_p(meltygui_imgui.VERTEX_BUFFER_COL_OFFSET))
    ...
    def render(self, draw_data):
        ...
        for commands in draw_data.commands_lists:
            ...
            gl.glBufferData(gl.GL_ARRAY_BUFFER, commands.vtx_buffer_size * meltygui_imgui.VERTEX_SIZE, ctypes.c_void_p(commands.vtx_buffer_data), gl.GL_STREAM_DRAW)
            ...
            for command in commands.commands:
                ...
                idx_buffer_offset += command.elem_count * meltygui_imgui.INDEX_SIZE
...
class FixedPipelineRenderer(BaseOpenGLRenderer):
    ...
    def render(self, draw_data):
        ...
        for commands in draw_data.commands_lists:
            ...
            gl.glVertexPointer(2, gl.GL_FLOAT, meltygui_imgui.VERTEX_SIZE, ctypes.c_void_p(commands.vtx_buffer_data + meltygui_imgui.VERTEX_BUFFER_POS_OFFSET))
            gl.glTexCoordPointer(2, gl.GL_FLOAT, meltygui_imgui.VERTEX_SIZE, ctypes.c_void_p(commands.vtx_buffer_data + meltygui_imgui.VERTEX_BUFFER_UV_OFFSET))
            gl.glColorPointer(4, gl.GL_UNSIGNED_BYTE, meltygui_imgui.VERTEX_SIZE, ctypes.c_void_p(commands.vtx_buffer_data + meltygui_imgui.VERTEX_BUFFER_COL_OFFSET))
            ...
            for command in commands.commands:
                ...
                idx_buffer += (command.elem_count * meltygui_imgui.INDEX_SIZE)
