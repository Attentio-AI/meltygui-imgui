...
class PygletMixin(object):
    REVERSE_KEY_MAP = {
        key.TAB: meltygui_imgui.KEY_TAB,
        key.LEFT: meltygui_imgui.KEY_LEFT_ARROW,
        key.RIGHT: meltygui_imgui.KEY_RIGHT_ARROW,
        key.UP: meltygui_imgui.KEY_UP_ARROW,
        key.DOWN: meltygui_imgui.KEY_DOWN_ARROW,
        key.PAGEUP: meltygui_imgui.KEY_PAGE_UP,
        key.PAGEDOWN: meltygui_imgui.KEY_PAGE_DOWN,
        key.HOME: meltygui_imgui.KEY_HOME,
        key.END: meltygui_imgui.KEY_END,
        key.INSERT: meltygui_imgui.KEY_INSERT,
        key.DELETE: meltygui_imgui.KEY_DELETE,
        key.BACKSPACE: meltygui_imgui.KEY_BACKSPACE,
        key.SPACE: meltygui_imgui.KEY_SPACE,
        key.RETURN: meltygui_imgui.KEY_ENTER,
        key.ESCAPE: meltygui_imgui.KEY_ESCAPE,
        key.NUM_ENTER: meltygui_imgui.KEY_PAD_ENTER,
        key.A: meltygui_imgui.KEY_A,
        key.C: meltygui_imgui.KEY_C,
        key.V: meltygui_imgui.KEY_V,
        key.X: meltygui_imgui.KEY_X,
        key.Y: meltygui_imgui.KEY_Y,
        key.Z: meltygui_imgui.KEY_Z,
    }
    _gui_time = None

    MOUSE_CURSORS = {
        meltygui_imgui.MOUSE_CURSOR_ARROW: Window.CURSOR_DEFAULT,
        meltygui_imgui.MOUSE_CURSOR_TEXT_INPUT: Window.CURSOR_TEXT,
        meltygui_imgui.MOUSE_CURSOR_RESIZE_ALL: Window.CURSOR_SIZE,
        meltygui_imgui.MOUSE_CURSOR_RESIZE_NS: Window.CURSOR_SIZE_UP_DOWN,
        meltygui_imgui.MOUSE_CURSOR_RESIZE_EW: Window.CURSOR_SIZE_LEFT_RIGHT,
        meltygui_imgui.MOUSE_CURSOR_RESIZE_NESW: Window.CURSOR_SIZE_DOWN_LEFT,
        meltygui_imgui.MOUSE_CURSOR_RESIZE_NWSE: Window.CURSOR_SIZE_DOWN_RIGHT,
        meltygui_imgui.MOUSE_CURSOR_HAND: Window.CURSOR_HAND
    }
    ...
    def __init__(self):
        ...
        self._cursor = -2
        self._window = None
        # Let Dear meltygui_imgui know we have mouse cursor support
        self.io.backend_flags |= meltygui_imgui.BACKEND_HAS_MOUSE_CURSORS
    ...
    def _handle_mouse_cursor(self):
        if self.io.config_flags & meltygui_imgui.CONFIG_NO_MOUSE_CURSOR_CHANGE:
            return

        mouse_cursor = meltygui_imgui.get_mouse_cursor()
        window = self._window
        if self._cursor != mouse_cursor:
            self._cursor = mouse_cursor
            if mouse_cursor == meltygui_imgui.MOUSE_CURSOR_NONE:
